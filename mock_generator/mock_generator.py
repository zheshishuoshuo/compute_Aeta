...
def run_mock_simulation(n_samples, maximum_magnitude=26.5, zl=0.3, zs=2.0,
                        if_source=False, process=None, alpha_s=-1.3,
                        m_s_star=24.5):
    ...
    if process is None or process == 0:
        ...
        # ===== 并行计算 =====
        args = [(i, samples, beta_samp, logalpha_sps_sample,
